...
class _Plan_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_4.alignment()))))));
  }
  fromValue(value_0) {
    return {
...
class _Either_1 {
  ...
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.is_left).concat(_descriptor_9.toValue(value_0.left).concat(_descriptor_1.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      checkEligibility: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkEligibility',
                                     ...
                                     'duskpay.compact line 24 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      requestPlan: (...args_1) => {
        if (args_1.length !== 7) {
          throw new __compactRuntime.CompactError(`requestPlan: expected 7 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        const privateInput_0 = args_1[6];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('requestPlan',
                                     'argument 1 (as invoked from Typescript)',
                                     'duskpay.compact line 28 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(planId_0).concat(_descriptor_1.toValue(merchant_0).concat(_descriptor_2.toValue(totalAmount_0).concat(_descriptor_2.toValue(installmentAmount_0).concat(_descriptor_3.toValue(installmentCount_0).concat(_descriptor_2.toValue(privateInput_0)))))),
            alignment: _descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_2.alignment())))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      payInstallment: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('payInstallment',
                                     'argument 1 (as invoked from Typescript)',
                                     'duskpay.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(planId_0.buffer instanceof ArrayBuffer && planId_0.BYTES_PER_ELEMENT === 1 && planId_0.length === 32)) {
      ...
      checkStatus: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkStatus',
                                     'argument 1 (as invoked from Typescript)',
                                     'duskpay.compact line 84 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(planId_0.buffer instanceof ArrayBuffer && planId_0.BYTES_PER_ELEMENT === 1 && planId_0.length === 32)) {
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(threshold_0) === 'bigint' && threshold_0 >= 0n && threshold_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'duskpay.compact line 18 char 1',
                                 'Uint<0..18446744073709551616>',
                                 threshold_0)
    }
  ...
  _callerAddress_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('callerAddress',
                                 'return value',
                                 'duskpay.compact line 22 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
                 ...
                 privateInput_0)
  {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(plan_0),
  ...
  _payInstallment_0(context, partialProofData, planId_0) {
    __compactRuntime.assert(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'Plan not found');
    const plan_0 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                             partialProofData,
                                                                             [
                                                                              { dup: { n: 0 } },
                                                                              { idx: { cached: false,
    ...
    const newPaidCount_0 = ((t1) => {
                             if (t1 > 4294967295n) {
                               throw new __compactRuntime.CompactError('duskpay.compact line 64 char 24: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                             }
                             return t1;
                           })(plan_0.paidCount + 1n);
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(planId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(updatedPlan_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'duskpay.compact line 14 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
